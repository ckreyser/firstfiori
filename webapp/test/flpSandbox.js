		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "First Fiori",
									"targetURL": "#nsfirstfiori-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsfirstfiori-display": {
								"semanticObject": "nsfirstfiori",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.firstfiori",
									"url": sap.ui.require.toUrl("ns/firstfiori")
								}
							}
						}
					}
